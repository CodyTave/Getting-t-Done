    ...
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
          <a href="/" className="flex items-center ps-2.5 mb-5 gap-2.5">
            <Logo white className="w-12 h-12" />
              ...
              <li key={index}>
                ...
                >
                  ...
                  {item.badge && (
                    <span
                      className={
                        "inline-flex items-center justify-center px-2 ms-3 text-sm font-medium rounded-full bg-gray-700 text-gray-300 " +
                          item.badgeColor || ""
                      }
                    >
                      {item.badge}
      ...
      <div className="p-4 sm:ml-64 mt-5">{children}</div>
    </>
  );
}
